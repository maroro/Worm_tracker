function  frame_trace_data = trace_worm(data,k)
...
%% Trace worm outline and find angles%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    BoundaryList = data.WorkingFrame.frame_mask_data.FrameBoundary;
    boundary_lengths = [];
    ...
    Bd_angle = unwrap(angle(cBB ./ cAA));
    % This operation computes the angle (in radians)
